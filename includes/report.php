          ...
          <form id="reportForm" method="GET" >
            <div class="form-group">
              ...
              <select class="form-control" id="reportType" name="reportType" required>
                ...
                <option value="pending">Reporte de prestamos pendientes</option>
                <option value="received">Reporte de prestamos recibidos</option>
              </select>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="generateReport" class="btn btn-primary">Generar reporte</button>
          </form>
        </div>
      </div>
    </div>
...
if(isset($_SESSION['reportGenerated']) && $_SESSION['reportGenerated'] === true) {
  ...
  unset($_SESSION['reportGenerated']);
}
?>
