...
<script>
  ...
  <div class="card-header">
    <div class="row">
      <div class="col-md-6">
        <h4 class="card-title">Añadir prestamo</h4>
      </div>
    </div>
  </div>
<?php
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $username = "if0_37224381";
  $password = "Mew5cFiXoHoCxN";
  ...
  if (mysqli_query($conn, $sql)) {
    echo '<script type="text/javascript">alert("Prestamos agregado correctamente!");</script>';
...
<div class="card-body">
  <form method="POST">
    ...
    <div class="form-group">
      <label for="date">Fecha del prestamo:</label>
    ...
    <div class="form-group">
      ...
      <small class="form-text text-muted">Maximo 250 caracteres.</small>
    </div>
    <div class="form-group">
