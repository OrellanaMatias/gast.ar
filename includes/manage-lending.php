...
if (strlen($_SESSION['detsuid']==0)) {
  header('location:logout.php');
    ...
    if (isset($_GET['delid'])) {
        ...
        if ($query) {
            echo "<script>alert('Prestamos agregado correctamente!);</script>";
...
$(document).ready(function() {
    ...
    $('#search-input').on('keyup', function() {
        ...
        if(!found) {
            $('table tbody').html('<tr><td colspan="8" style="text-align:center;">Sin datos que mostrar</td></tr>');
        }
    });
});
            ...
            <div class="panel panel-default">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Ver prestamos</h4>
                                        ...
                                        ?>
                                          ...
                                          <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $row['id']; ?>">
                                              <a class="dropdown-item edit-btn" href="#" data-toggle="modal" data-target="#editExpenseModal<?php echo $row['id']; ?>" data-expense-id="<?php echo $row['id']; ?>"><i class="fas fa-edit"></i>Editar</a>
                                              <a class="dropdown-item" href="manage-lending.php?delid=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"></i>Borrar</a>
                                            </div>
                                          </div>
                                                    ...
                                                    <form action="update-lending.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="edit-expense-status" name="status">
                                                                ...
                                                                <option value="received" <?php if($row['status'] == 'received') echo 'selected'; ?>>Recibido</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="edit-expense-amount">Monto del gasto:</label>
                                                            <input type="number" class="form-control" id="edit-expense-amount" name="amount" value="<?php echo $row['amount']; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="edit-expense-description">Descripcion del gasto:</label>
...
$('#expense-form').validate({
  ...
  messages: {
    dateexpense: {
      required: "Ingresa una fecha valida."
    },
    item: {
      required: "Ingresa un nombre."
    },
    costitem: {
      required: "Ingresa un costo valido.",
