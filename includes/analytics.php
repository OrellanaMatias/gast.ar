...
<body>
  ...
  <div class="logo-details">
      ...
      <span class="logo_name">Gast.ar</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="home.php">
...
fetch('pie-data.php')
  ...
  .then(data => {
    if (data.length == 0) {
      ...
      noDataMessage.textContent = 'Sin datos por ahora, ponte a gastar :p';
        ...
        tooltips: {
          callbacks: {
            label: function(tooltipItem, data) {
              ...
              return `${label}: ${percentage}% ~ ARS ${expense}`;
            }
          }
        },
        legend: {
      ...
      plugins: [{
        beforeInit: function(chart, options) {
          ...
          for (let i = 0; i < labels.length; i++) {
            ...
            label.textContent = `${labels[i]}: ${percentages[i]}% ~ ARS ${expenses[i]}`;
