...
var tableFooter = '<tr>' +
                    '<td colspan="5" style="text-align:center; border: 1px solid black;">Monto final &copy; 2024</td>' +
...
nw.document.write('<html><head><title>Reporte de recibidos? - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Reporte de prestamos recibidos</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Recibido <?php echo ucfirst($rtype); ?> Reporte de <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
