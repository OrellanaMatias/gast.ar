...
var tableFooter = '<tr>' +
                    '<td colspan="5" style="text-align:center; border: 1px solid black;">Total final &copy; 2024</td>' +
...
nw.document.write('<html><head><title>Reporte de gastos - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Por fecha <?php echo ucfirst($rtype); ?> Report from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
          ...
          <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
              ...
              <tr>
              <th colspan="5" style="text-align:center">Monto final</th>
          ...
          <?php
            ...
            echo "<p style='text-align:center'><b>Sin datos por ahora xd</p>";
          }
          ?>
        </div>
      </div>
