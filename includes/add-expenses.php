...
if (strlen($_SESSION['detsuid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query) {
      ...
      $message = "El gasto no pudo ser agregado :c";
      echo "<script type='text/javascript'>alert('$message');</script>";
    }
    ...
    <div class="modal-content">
      <form id="add-category-form" method="post" action="add_category.php">
        <div class="modal-header">
          <h5 class="modal-title" id="add-category-modal-title">Añadir categoria</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="add-category-submit">Añadir categoria</button>
...
<div class="form-group">
  ...
  <select class="form-control" id="category" name="category" required>
    <option value="" selected disabled>Elegir categoria</option>
    <?php
    $userid = $_SESSION['detsuid'];
    ...
    ?>
      ...
      <div class="form-group">
        <label for="costitem">Monto gastado</label>
